const Privacy = () => {
  return (
    <div className='container'>
      ...
      <p>
        This privacy notice for CanYou Inc. (doing business as CanYou)
        (&quot;CanYou,&quot; &quot;we,&quot; &quot;us,&quot; or
      ...
      <ul>
        <li>
          <p>
            Visit our website at https://canyouapp.com, or any website of ours
      ...
      <p>
        ...
        how you interact with CanYou and the Services, the choices you make, and
      ...
      <p>
        ...
        about what CanYou does with any information we collect?
      </p>
      <p>
        <br />
      </p>
      ...
      <p>
        ...
        contact us at support@bestimate.tech.
      </p>
      <p>
        <br />
      </p>
      ...
      <p>
        ...
        email us at support@bestimate.tech.
      </p>
      <p>
        <br />
      </p>
      ...
      <p>
        You may contact us by email at support@bestimate.tech,&nbsp;or by
      ...
      <p>
        CanYou Inc. has not sold any personal information to third parties for a
        business or commercial purpose in the preceding twelve (12)
        months.&nbsp;CanYou Inc. has disclosed the following categories of
      ...
      <p>
        ...
        support@bestimate.tech,&nbsp;or by referring to the contact details at
      ...
      <p>
        ...
        your personal information, please submit a request by sending an email
        to&nbsp;<a href='mailto:support@canyouapp.com'>support@canyouapp.com</a>{' '}
        with the subject: &ldquo;ATTN: Privacy&rdquo;.
      </p>
      <p>
        <br />
      </p>
